...
string SUFFIX = "M1";            // Assume in a machine but should get correct suffix later
    ...
    link_message(integer sender, integer num, string m, key id)
    {
        ...
        if (cmd == "REZ_PRODUCT")
        {
            ...
            if (llList2String(tok, 1) == PASSWORD)
            {
                ...
                postMessage("task=actions&data1=" +llList2String(tok, 2) +"&data2=" +action +";" +PREFIX +";" +product);
            }
            else
            {
